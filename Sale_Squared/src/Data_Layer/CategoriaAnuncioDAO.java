...
public class CategoriaAnuncioDAO implements Map<String, Categoria> {
	...
	// construtor
	public CategoriaAnuncioDAO(int codAnuncArg) {
	...
	public void clear() {
		...
		try {
			String sql = "DELETE FROM " + CATEGORIA_A_T
					+ " WHERE cata.anuncio = ?";
	...
	public boolean containsKey(Object key) throws NullPointerException {
		...
		try {
			...
			String sql = "SELECT * FROM " + CATEGORIA_A_T
					+ " WHERE cata.anuncio = ? AND cata.categoria = ?";
			PreparedStatement stm = ConexaoBD.getConexao()
					.prepareStatement(sql);
			stm.setInt(1, this.codAnunc);
	...
	public boolean containsValue(Object value) {
		throw new NullPointerException(
				"Categoria_Anuncio_containsValue não está implementado!");
	}

	public Set<Map.Entry<String, Categoria>> entrySet() {
		throw new NullPointerException(
				"Categoria_Anuncio_entrySet não está implementado!");
	}

	public boolean equals(Object o) {
		throw new NullPointerException(
				"Categoria_Anuncio_equals não está implementado!");
	}
	...
	public Set<String> keySet() {
		...
		try {
			...
			String sql = "SELECT categoria FROM " + CATEGORIA_A_T
					+ " WHERE cata.anuncio = ?";
			PreparedStatement stm = ConexaoBD.getConexao()
					.prepareStatement(sql);
			stm.setInt(1, this.codAnunc);
	...
	public void putAll(Map<? extends String, ? extends Categoria> t) {
		throw new NullPointerException(
				"Categoria_Anuncio_putAll não está implementado!");
	}
