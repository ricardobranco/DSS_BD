...
public class MsgEnviadaDAO implements Map<Integer, Mensagem> {
	...
	// construtor
	public MsgEnviadaDAO(String usernameArg) {
	...
	public void clear() {
		...
		try {
			String sql = "DELETE FROM " + MENSAGEM_T
					+ " WHERE m.emissor = ? AND m.pertence = ?";
	...
	public boolean containsValue(Object value) {
		throw new NullPointerException(
				"Msg_Env_containsValue não está implementado!");
	}

	public Set<Map.Entry<Integer, Mensagem>> entrySet() {
		throw new NullPointerException(
				"Msg_Env_entrySet não está implementado!");
	}

	public boolean equals(Object o) {
		throw new NullPointerException(
				"Msg_Env_equals não está implementado!");
	}
	...
	public void putAll(Map<? extends Integer, ? extends Mensagem> t) {
		throw new NullPointerException("Msg_Env_putAll não implementado!");
	}
