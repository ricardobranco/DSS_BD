...
public class Tabela_Vendas extends JPanel {
	...
	public Tabela_Vendas(final Sale_Squared root) {
		...
		dm.setDataVector(new Object[][] {}, new Object[] { "Data Início", "Data de Fim","Negócio","Preço","Estado","Leilão","Comprar Já"});
	    ...
	    //teste
	    Object[] row1 = {"3/1/2013","13/1/2013","Negócio 1","€ 15","Aberto",true,false};
