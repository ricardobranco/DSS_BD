...
public class Inserir_preco extends JPanel {
	...
	public Inserir_preco() {
		...
		JLabel lblIncrementoMnimo = new JLabel("Incremento m\u00EDnimo    \u20AC");
		lblIncrementoMnimo.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		
		JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"0.01", "0.05", "0.10", "0.50", "1.00", "5.00", "10.00", "50.00", "100.00", "500.00", "1000.00", "5000.00", "10000.00"}));
