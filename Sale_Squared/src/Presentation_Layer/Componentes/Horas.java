...
public class Horas extends JPanel {
	...
	public Horas() {
		...
		SpinnerNumberModel smh = (new SpinnerNumberModel((double) (new GregorianCalendar().get(GregorianCalendar.HOUR_OF_DAY)),0,23,1));
		SpinnerNumberModel smm = (new SpinnerNumberModel((double) (new GregorianCalendar().get(GregorianCalendar.MINUTE)),0,59,1));
