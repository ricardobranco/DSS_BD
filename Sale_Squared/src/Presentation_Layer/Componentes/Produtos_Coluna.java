...
public class Produtos_Coluna extends JPanel {
	...
	public Produtos_Coluna(final Sale_Squared root) {
		...
		panel.add(new Produto_Base(root, "Produto", true, 100, true, 50,
				"2 dias - 14h:34m:23s"), "Produto");

		JPanel panel_1 = new JPanel();
		panel_1.add(new Produto_Base(root, "Produto", true, 100, true, 50,
				"2 dias - 14h:34m:23s"), "Produto");

		JPanel panel_2 = new JPanel();
		panel_2.add(new Produto_Base(root, "Produto", true, 100, true, 50,
				"2 dias - 14h:34m:23s"), "Produto");

		JPanel panel_3 = new JPanel();
		panel_3.add(new Produto_Base(root, "Produto", true, 100, true, 50,
				"2 dias - 14h:34m:23s"), "Produto");

		JPanel panel_4 = new JPanel();
		panel_4.add(new Produto_Base(root, "Produto", true, 100, true, 50,
				"2 dias - 14h:34m:23s"), "Produto");
