 ...
 */
package Presentation_Layer.com.toedter.calendar;
...
public class JDateChooser extends JPanel implements ActionListener,
	...
	public JDateChooser(JCalendar jcal, Date date, String dateFormatString,
		...
		calendarButton = new JButton(new ImageIcon(JDateChooser.class.getResource("/Imagens/JDateChooserIcon.gif"))) {
	...
	public GregorianCalendar getData(){
		Calendar calendario = jcalendar.getCalendar();
