			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(progressBar_1, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_2, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_3, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_4, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_5, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_6, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_8, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
						.addComponent(progressBar_7, GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
					.addContainerGap())
		);
		gl_panel_1.setVerticalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addComponent(progressBar_1, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_2, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_3, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_4, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_5, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_6, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_7, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(progressBar_8, GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
					.addGap(6))
		);
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblNewLabel_8, Alignment.TRAILING))
					.addContainerGap())
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(lblNewLabel_5, GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					...
					.addGap(18)
					.addComponent(lblNewLabel_8, GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE)
					.addGap(12)
					.addComponent(lblNewLabel_2, GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE)
					.addGap(18)
					.addComponent(lblNewLabel_3, GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE)
					.addGap(18)
					.addComponent(lblNewLabel_4, GroupLayout.DEFAULT_SIZE, 16, Short.MAX_VALUE)
					.addContainerGap())
		);
