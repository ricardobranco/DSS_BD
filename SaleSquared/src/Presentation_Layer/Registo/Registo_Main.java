...
public class Registo_Main extends JPanel {
    ...
    public Registo_Main(final Sale_Squared root) {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    Imagem imagem = new Imagem("Avatar" + id, r2.getAvatar());
                    ...
                    JOptionPane.showMessageDialog(root, new JLabel(html1 + "300" + html2 + e.getMessage()), html2, WIDTH, new javax.swing.ImageIcon(getClass().getResource("/Imagens/Sem_Imagem.png")));
                }
        ...
        groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
                ...
                .addComponent(panel, GroupLayout.DEFAULT_SIZE, 32,
                Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 34,
                Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 30,
                Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(panel_3, GroupLayout.DEFAULT_SIZE, 24,
                Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(panel_4, GroupLayout.DEFAULT_SIZE, 26,
                Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
