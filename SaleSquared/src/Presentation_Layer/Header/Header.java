...
public class Header extends JPanel {
	...
	public Header(final Sale_Squared root) {
		...
		button.setIcon(new ImageIcon(Header.class
				.getResource("/Imagens/header.png")));
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addComponent(pesquisa, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(button)
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(pesquisa, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE)
