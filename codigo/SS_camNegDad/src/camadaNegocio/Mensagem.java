...
public class Mensagem {
    ...
    public UtilizadorRegistado getEmissor() {return emissor;}
    public void setEmissor(UtilizadorRegistado emissor) {this.emissor = emissor;}
    public UtilizadorRegistado getReceptor() {return receptor;}
    public void setReceptor(UtilizadorRegistado receptor) {this.receptor = receptor;}
    public GregorianCalendar getDataEnvio() {return dataEnvio;}
    public void setDataEnvio(GregorianCalendar dataEnvio) {this.dataEnvio = dataEnvio;}
